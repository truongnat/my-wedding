...
import { ImageWithOptimization } from '@/components/ui/image-with-optimization';
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
/**
 * Gallery component with carousel functionality
 *
 * Features:
 * - Embla carousel for smooth image browsing
 ...
 */
export function Gallery({ images = defaultImages, isLoading = false }: GalleryProps) {
...
/**
 * Loading skeleton for Gallery component
 */
